...
- Slice AG (75/76) [pre-flight](rust-port-slice-ag-preflight.md) [step 1](rust-port-slice-ag-step1.md) [step 2](rust-port-slice-ag-step2.md) — a line citation has an EXPIRY DATE, and a gate grid inherited across the boundary where its defect class is BORN cannot see it (one lesson per file)
