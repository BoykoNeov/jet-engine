...
- Slice AF (74) [pre-flight](rust-port-slice-af-preflight.md) [1](rust-port-slice-af-step1.md) [2](rust-port-slice-af-step2.md) [3](rust-port-slice-af-step3.md) [4](rust-port-slice-af-step4.md) [5a](rust-port-slice-af-step5a.md) [5b](rust-port-slice-af-step5b.md) — *what supplies the value?* has a sibling: *what has ever RUN the sentence?* (one lesson per file)
