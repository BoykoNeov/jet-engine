...
## The Rust port — phases 0–6 done; phase 7 in flight, slice AF (rung 74) CLOSED, all six steps
...
- Slice AF (74) [pre-flight](rust-port-slice-af-preflight.md) [1](rust-port-slice-af-step1.md) [2](rust-port-slice-af-step2.md) [3](rust-port-slice-af-step3.md) [4](rust-port-slice-af-step4.md) [5a](rust-port-slice-af-step5a.md) [5b](rust-port-slice-af-step5b.md) [6 closed](rust-port-slice-af-step6.md) — *what supplies the value?* has a sibling: *what has ever RUN the sentence?*, and a second one: *is this line a DISPATCH in the source at all?* (one lesson per file)
