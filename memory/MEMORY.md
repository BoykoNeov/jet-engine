...
## The Rust port — decided 2026-08-12; **PHASES 0–6 DONE** — phase 6 authorised 2026-08-17 and **COMPLETED 2026-08-20** with slice U's five steps; **PHASE 7 AUTHORISED 2026-08-20**, slice V (of V…AJ) pre-registered and in step 1
...
- Slice V (57-60) [authorised + steps 1a/1b](rust-port-slice-v.md) [step 2](rust-port-slice-v-step2.md) — a census matches a SHAPE, so a bare permanent assignment was invisible to one built on `try/finally`; both gates written to CLOSE a step could not fail — check falsifiability, never greenness
