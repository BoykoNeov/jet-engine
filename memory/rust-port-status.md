...
## Slice AH (rungs 77 + 78, `StiffnessLedgerTransient` + `ResidualGaugeTransient`) — IN FLIGHT, steps 1–6 done, BOTH SUITES PORTED; oracle + dispatch owed
