...
| 1 | the golden-fingerprint gate | the real work; worth landing on its own merits |
...
| **rung-66 two-lag cascade march, BOTH clocks armed** (341 rows) | **6 152** | **0 — bit-identical** | — |
